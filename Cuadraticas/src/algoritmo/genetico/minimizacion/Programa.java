...
public class Programa {
    ...
    public static void main(String[] args) throws Exception {
        ...
        FuncionDeAptitud funcionAMinimizar2 = new FuncionCuadratica("-100x^2+2500x-15000", -10, 20);
        ...
        AlgoritmoGenetico minimizarFuncion = new AlgoritmoGenetico(100, 0.001, 0.25, 0.5, funcionAMinimizar2, cortePorIteraciones);
